...
export const getTxDetails = async (
  transaction: Partial<
    Pick<
      ...
      'from' | 'to' | 'gasPrice' | 'gasLimit' | 'amount'
    >
  > &
...
export const getTransferNftTransaction = async (
  transaction: Pick<
    NewTransactionNonNullable,
    'asset' | 'from' | 'to' | 'gasPrice' | 'gasLimit'
  >
): Promise<TransactionDetailsReturned> => {
...
export const getTransferTokenTransaction = async (
  transaction: Pick<
    NewTransactionNonNullable,
    'asset' | 'from' | 'to' | 'amount' | 'gasPrice' | 'gasLimit'
  >
): Promise<TransactionDetailsReturned> => {
 ...
 * @return The estimated gas limit.
 */
export const estimateGasLimit = async (
  ...
  let estimateGasData: TransactionRequest = {
    data: '0x',
    from: address,
    to: _recipient,
    value,
